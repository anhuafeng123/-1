...
#主程序类
class AnHuaFeng_PlaneGame(object):
	#初始化
	def __init__(self):
		#游戏窗口
	...
	def __cretar_sprite(self):
		bg1 = AnHuaFeng_Background('./sdssmeitu_1_meitu_3.png')
		bg2 = AnHuaFeng_Background('./sdssmeitu_1_meitu_3.png',True)
		bg2.rect.x = -bg2.rect.width
		self.back_group = pygame.sprite.Group(bg1,bg2)
		self.hero = AnHuaFeng_Hero('./images/fhfVE1`A.png')
		self.hero_group = pygame.sprite.Group(self.hero)
		self.hero1 = AnHuaFeng_Hero1('./me1.png')
		self.hero1_group = pygame.sprite.Group(self.hero1)
		self.enemy = AnHuaFeng_Enemy('./images/sdssmeitu_1_meitu_3.png')
		self.enemy_group = pygame.sprite.Group(self.enemy)
		# self.hero2 = AnHuaFeng_Hero2('./images/life.png')
		# self.hero2_group = pygame.sprite.Group(self.hero2)
		# self.hero3 = AnHuaFeng_Hero3('./images/life.png')
	...
	def __event_handler(self):
		...
		for event in pygame.event.get():
			...
			if event.type == pygame.QUIT:
				...
				self.enemy_group.add(AnHuaFeng_Enemy('./images/sdssmeitu_1_meitu_3.png'))
...
if __name__  == '__main__':
	AnHuaFeng_game = AnHuaFeng_PlaneGame()
	AnHuaFeng_game.start_game()